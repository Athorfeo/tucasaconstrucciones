...
import { BsHouseFill, BsBagFill, BsInfoSquareFill, BsFacebook, BsInstagram } from "react-icons/bs";
import { FiFacebook, FiInstagram } from "react-icons/fi";

import './Navigation.css';
import logoSimple from '../../res/drawable/logo-simple.svg';
          ...
          <Navbar.Offcanvas className="" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" placement="end">
            ...
            <Offcanvas.Body>
              <Nav className="justify-content-end flex-grow-1 pe-3">
                <Nav.Link as={Link} to="/" className="item-navigation">
                  <BsHouseFill className="me-2"  />
                  Inicio
                  </Nav.Link>
                <Nav.Link as={Link} to="portfolio" className="item-navigation">
                  <BsBagFill className="me-2"  />
                  Proyectos
                  </Nav.Link>
                <Nav.Link as={Link} to="about" className="item-navigation">
              ...
              <div className="d-flex justify-content-center">
                <a href="https://www.instagram.com/tucasa_construcciones/" target="_blank"  className="text-dark"><FiFacebook className="me-2" size={30}/></a>
